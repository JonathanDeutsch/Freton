...
centers_ext = ones(2,numel(nTraces))*4;
size(centers_ext)
pause
...
uisave({'time_axis','centers_ext','don_tot_trace','don_spec_trace','don_bckg_trace','accep_tot_trace','accep_spec_trace','accep_bckg_trace','Mode1','Picture_d','Picture_a'})
% size(don_traces)
% size(accep_traces)
% size(fret_traces)
